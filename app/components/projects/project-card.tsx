          ...
          <div className="flex gap-3 pt-3 mt-auto border-t border-border">
            {github && (
              <a
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 border border-border font-plex-mono text-[10px] uppercase tracking-wider
                           text-muted-foreground hover:border-primary hover:text-primary transition-colors duration-300"
              >
            ...
            {liveUrl && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-1.5 px-3 py-1.5 bg-primary text-background font-plex-mono text-[10px] uppercase tracking-wider
